...
public class AthleteSpinnerCursorAdapter extends CursorAdapter {

	public AthleteSpinnerCursorAdapter(Context context, Cursor c, int flags) {
		super(context, c, flags);
		MyLog.i("AthleteSpinnerCursorAdapter", "constructor.");
	}
