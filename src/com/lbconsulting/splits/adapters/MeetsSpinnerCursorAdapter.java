...
public class MeetsSpinnerCursorAdapter extends CursorAdapter {

	public MeetsSpinnerCursorAdapter(Context context, Cursor c, int flags) {
		super(context, c, flags);
		MyLog.i("MeetsSpinnerCursorAdapter", "constructor.");
	}
	...
	public void bindView(View view, Context context, Cursor cursor) {
		if (cursor != null) {
			...
			if (id == R.id.llRow) {
				...
				if (tvRow != null) {
					tvRow.setText(cursor.getString(cursor.getColumnIndexOrThrow(MeetsTable.COL_TITLE)));
				}
			} else if (id == R.id.llRowDropdown) {
				TextView tvDropdownRow = (TextView) view.findViewById(R.id.tvDropdownRow);
				if (tvDropdownRow != null) {
					tvDropdownRow.setText(cursor.getString(cursor.getColumnIndexOrThrow(MeetsTable.COL_TITLE)));
				}
			}
		}
	}
