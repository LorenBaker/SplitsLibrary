...
public class EventsSpinnerCursorAdapter extends CursorAdapter {

	public EventsSpinnerCursorAdapter(Context context, Cursor c, int flags) {
		super(context, c, flags);

		MyLog.i("EventsSpinnerCursorAdapter", "constructor.");
	}
	...
	public void bindView(View view, Context context, Cursor cursor) {
		if (cursor != null) {
			...
			if (id == R.id.llRow) {
				...
				if (tvRow != null) {
					tvRow.setText(cursor.getString(cursor
