...
public class BestTimesAthletesSpinnerCursorAdapter extends CursorAdapter {

	public BestTimesAthletesSpinnerCursorAdapter(Context context, Cursor c, int flags) {
		super(context, c, flags);
		MyLog.i("BestTimesAthletesSpinnerCursorAdapter", "constructor.");
	}
